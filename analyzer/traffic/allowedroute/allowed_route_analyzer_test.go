...
func Test_Analyze(t *testing.T) {
	...
	tests := []struct {
		name                 string
		args                 args
		expectedAllowedRoute *shared.AllowedRoute
	}{
		{
	...
	for _, tt := range tests {
		allowedRoute := analyzerImpl{}.Analyze(tt.args.sourcePodIsolation, tt.args.targetPodIsolation, tt.args.namespaces)
